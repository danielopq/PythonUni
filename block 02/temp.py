...
def usage():
    ''' Print usage message '''
    print("Usage: ", sys.argv[0], "[options] [count] [delay]")
...
# create threads
dt = DepositThread("Depositing thread", my_acc, 100, count, delay)
wt = WithdrawThread("Withdrawing thread", my_acc, 100, count, delay)
